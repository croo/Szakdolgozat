...
public class Main implements EntryPoint
{
	...
	public void onModuleLoad()
	{
		...
		FilterServiceAsync filterService = GWT.create(FilterService.class);
		TravelServiceAsync travelService = GWT.create(TravelService.class);

		TravelMapView map = new TravelMapView(eventBus, mapService, filterService);
		// FilterView filtering = new FilterView(eventBus, filterService);
